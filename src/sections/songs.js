...
const renderSongs = (songs) => {
  ...
  //console.log(songListItemTemplate);
  //console.log("test");
  songs.forEach((song) => {
    ...
    //créer mon lien song-id pour les lyrics
    ...
    const favoriteIcon = newSongItem.querySelector(
...
const renderSongsForSearchSection = async (query) => {
  ...
  songSectionTitle.textContent = `Résultats pour "${decodeURIComponent(
    query
  )}"`;
